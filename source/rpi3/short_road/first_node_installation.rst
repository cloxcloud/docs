...
.. _rpi3_the_short_road_first_node:

******************************************
First node deployment
******************************************

This guide intends to describe the process of deploying your first node. We will call it "**box0**". This node is nothing else than a basic compute node plus an LXD container running OpenNebula. A ready to be deployed image have been created, check :ref:`rpi3_the_short_road_first_node`.
