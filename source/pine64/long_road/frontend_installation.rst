.. include:: ../vars.rst
.. _pine64_the_not_so_short_road_frontend_installation:
...
You can find OpenNebula dependencies `here <http://docs.opennebula.org/5.4/integration/references/build_deps.html#build-deps>`_.
...
.. prompt:: bash # auto
    ...
    libxmlrpc3-common-java libxslt1-dev libcurl4-openssl-dev ruby scons libxmlrpc-c++8-dev nfs-common genisoimage qemu-utils
...
.. prompt:: bash # auto
    ...
    # wget http://downloads.opennebula.org/packages/opennebula-5.4.6/opennebula-5.4.6.tar.gz
    # tar -xvzf opennebula-5.4.6.tar.gz
    # cd opennebula-5.4.6
    # scons
...
Download systemd units from clox's git:

.. prompt:: bash $ auto

    $ git clone https://github.com/cloxcloud/opennebula_systemd_units

Copy units to **/lib/systemd/system/**, set permissions and reload systemd.

.. prompt:: bash # auto

    # cp opennebula_systemd_units/5.4/opennebula* /lib/systemd/system/
...
This add-on will allow OpenNebula to manage LXD containers.
